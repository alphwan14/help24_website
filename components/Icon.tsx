...
const paths: Record<string, React.ReactNode> = {
  ...
  android: (
    <path d="M6 10v7a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1v-7z M6 10a6 6 0 0 1 12 0 M9 7.5h.01 M15 7.5h.01 M7.5 5 6 3 M16.5 5 18 3 M4 11.5v4 M20 11.5v4 M9.5 18v2.5 M14.5 18v2.5" />
  ),
  qr: (
    <path d="M4 4h6v6H4z M14 4h6v6h-6z M4 14h6v6H4z M14 14v2 M20 14v2 M14 20h2 M20 20v-2" />
  ),
  copy: (
    <path d="M9 9h10a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1V10a1 1 0 0 1 1-1z M5 15H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v1" />
  ),
  lock: (
  ...
  chip: (
    <path d="M8 8h8v8H8z M6 4h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z M9 1v3 M15 1v3 M9 20v3 M15 20v3 M1 9h3 M1 15h3 M20 9h3 M20 15h3" />
  ),
