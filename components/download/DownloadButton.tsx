...
export function DownloadButton({
  ...
  return (
    <a
      ...
      className={`group inline-flex items-center justify-center gap-3 rounded-button bg-action px-8 py-4 text-body-lg font-semibold text-on-action shadow-card transition-all duration-200 hover:opacity-95 hover:shadow-lift active:opacity-90 ${className}`}
    >
