...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      {/* One ground layer: a wide, very low bleed of brand colour so the top of
          the page is warmer than the bottom. It is theme-aware — see
          `.bg-atmosphere` in globals.css for why light needs less of it.

          THE 64px GRID THAT USED TO SIT UNDER THIS IS GONE. It drew a lattice
          of squares behind the headline, and a background made of boxes is the
          one texture that makes a page read as a template rather than as a
          product. The wash stays because it has no edges and no shape; the grid
          went because it was nothing but edges. */}
